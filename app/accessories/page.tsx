...
<div className="centered-text">Accessories</div>
</div>
      <div className="bg-white">
    
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <h2 className="text-center text-gray-900 text-2xl font-bold py-8">
          TechData Computing: Enhance Your Wireless System with Our Antennas and Modules</h2>
          <p className="text-sm sm:text-lg mt-3 mb-3 leading-8 text-gray-600">
        
          Improve your wireless network with our range of high-quality antennas and modules, designed to provide enhanced performance and connectivity. Our antennas offer key properties including gain, direction, and polarization to optimize your wireless system. Gain measures the power increase, direction refers to the transmission pattern, and polarization impacts signal clarity. Our antennas are compatible with Cisco Aironet® and Catalyst® wireless LAN and wireless bridge systems, providing versatile coverage options. Note that as gain increases, there may be a tradeoff in coverage area.

              </p>
          <h2 className=" text-gray-900 text-2xl font-bold py-8">Explore Our Solutions:</h2>

          <ul className="list-disc pl-5 space-y-2 text-gray-700">
        <li className="flex items-start text-sm sm:text-lg">
          <span className="mr-2 text-indigo-600">•</span>
          <span>Antennas: Improve your wireless network with antennas that offer customizable gain, direction, and polarization, tailored to meet the needs of your Cisco Aironet® and Catalyst® systems.</span>
        </li>
        <li className="flex items-start text-sm sm:text-lg">
          <span className="mr-2 text-indigo-600">•</span>
          <span>Cisco Transceiver Modules: Our selection includes modules for various Ethernet connectivity needs, suitable for enterprise wiring closets, data centers, and service provider transport applications.

</span>
        </li>
        <li className="flex items-start text-sm sm:text-lg">
          <span className="mr-2 text-indigo-600">•</span>
          <span>Cisco Stack Kit: Featuring Cisco StackWise-160 technology, the Stack Kit supports stacking modules and local switching for Cisco Catalyst 3650 Series Switches, enhancing network performance and scalability.
